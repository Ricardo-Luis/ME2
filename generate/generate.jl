...
function sidebar_code(book_model)
    ...
    <br>
    <img src="$(SLASH_PREPATH)/isel_logo.png" style="width: 175px; height: auto; vertical-align: middle">
    <img src="$(SLASH_PREPATH)/assets/julia-logo.svg" style="margin-left:2em; width: 80px; height: auto; vertical-align: middle">
